...
namespace WikEpubLib.CreateDocs
{
    ...
    /// </remarks>
    public class GetContentXml : IContentDocCreator
    {
        public async Task<IDocument> CreateContentDoc(IEnumerable<WikiPageRecord> wikiPageRecords, string bookTitle, string filePath)
        {
            ...
            return await Task.Run(() =>
            {
                ...
                return new ContentDoc(new XDocument(new XDeclaration("1,0", "utf-8", "no"), package), filePath);
            });
        }
